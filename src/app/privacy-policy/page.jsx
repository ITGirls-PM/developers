				...
				<div className={styles['privacy__content']}>
					<div className={styles['privacy__content_block']}>
						...
						<p>
							...
							персональных данных команды Code Wizards (далее – Оператор).
						</p>
						<p>
						...
						<p>
							...
							Оператор может получить о посетителях веб-сайта code-wizards.team
						</p>
					</div>
					<div className={styles['privacy__content_block']}>
						...
						<p>
							9. Пользователь – любой посетитель веб-сайта code-wizards.team
						</p>
						<p>
					...
					<div className={styles['privacy__content_block']}>
						...
						<p>
							...
							материалам, содержащимся на веб-сайте code-wizards.team уточнение
							деталей заказа.
						</p>
						<p>
							...
							электронной почты email@code-wizards.team с пометкой «Отказ от
					...
					<div className={styles['privacy__content_block']}>
						...
						<p>
							...
							через специальные формы, расположенные на сайте code-wizards.team.
					...
					<div className={styles['privacy__content_block']}>
						...
						<p>
							...
							Оператора email@code-wizards.team с пометкой «Актуализация
							персональных данных».
						</p>
						<p>
							...
							email@code-wizards.team с пометкой «Отзыв согласия на обработку
							персональных данных».
						</p>
					</div>
					<div className={styles['privacy__content_block']}>
