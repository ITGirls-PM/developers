        ...
        <div className={styles['privacy__content']}>
          <div className={styles['privacy__content_block']}>
            ...
            <p>
              ...
              Георгием Андреевичем Ламбертом (далее — Оператор).
            </p>
            <p>
            ...
            <p>
              ...
              веб-сайта https://remotellamas.com.
            </p>
          </div>
          <div className={styles['privacy__content_block']}>
          ...
          <div className={styles['privacy__content_block']}>
            ...
            <article className={styles['privacy__content_column']}>
              <p>Цель обработки</p>
              <p>
                уточнение деталей заказа, информирование Пользователя
                посредством отправки электронных писем.
              </p>
              <p>Персональные данные</p>
              <p>электронный адрес, имя.</p>
          ...
          <div className={styles['privacy__content_block']}>
            ...
            <p>
              ...
              Оператора egorka.lambert@gmail.com с пометкой «Актуализация
              персональных данных».
            </p>
            <p>
              ...
              egorka.lambert@gmail.com с пометкой «Отзыв согласия на обработку
              персональных данных».
            </p>
            <p>
          ...
          <div className={styles['privacy__content_block']}>
            ...
            <p>
              ...
              сети Интернет по адресу https://remotellamas.com/privacy.
            </p>
          </div>
        </div>
      </div>
