const practiceData = [
  {
    ...
    Объясню. Относиться к удаче можно с нескольких сторон. 
    
    Например, как к привратностям судьбы, божьему умыслу, стечению обстоятельств или дани за прошлые хорошие дела. В прицнипе — пожалуйста, но продуктивной составляющей в этом ноль. Вся ответственность за такое событие при таком отношении перекладывается на судьбу, Бога, обстоятельства или карму. 
    Если подойти к этому вопросу с прагматизмом, восприятие «удачи» — это критическая способность оценивать закономерности, которые к этой удаче привели. А что это такое? А это уже — нелинейное планирование. Приходим в мою профессиональную область, где я чувствую себя уверенно и могу пояснить со знанием дела 🙂
    Возьмём прям определение: «Нелинейное планирование — совокупность факторов благоприятных для выполнения той или иной задачи». Что-то чувсвутете, куда клюню, да? Не буду томить.
    При нелинейном планировании есть три суперважных состовляющих, которые необходимы профессионалу для эффективной работы: 
    1. умение видеть точки концентрации возможностей; 
    2. готовность воспользоваться шансом;
    3. умение быть в порядке.
    Совместив удачу и нелинейное планирование, в моей в практике появился специальный кейс для собеседования кандидатов в мою команду. 
    Делюсь! Я прошу рассказать про любое судьбоносное событие из жизни. И после рассказа задаю контрольный вопрос: «Какие закономерности привели к нему?». 
  
    Ну вот, теперь вы сможете легче поработать со мной при желании! 🙂 Тут есть подвох — правильного ответа на этот вопрос нет. Но есть нужное для развития в моей команде рассуждение. По опыту собеседований, вопрос — кладезь. `,
  },
  {
    id: 2,
    ...
    А ещё хотя бы раз в жизни каждый сталкивался с порицанием, публичным конфузом, критикой или дошедшими до вас сплетнями про вас же. Если вы индивидуум, который не может что-то такое вспомнить, вы либо мертвы, либо что-то не договариваете🙂
    Представьте, какой микс внутри из внушаемого поколениями ментального страха и личного опыта? Бррр... ☹️
    Расскажу, как периодически использую его себе во благо. 
    Есть такой вид дел, который я называю «проекты-жабы». Это что-то, что не хочется делать, но надо, а возможно и хочется, но условия там такие, что отбивает любую мотивацию и желание продолжать.
    Вот именно с такими задачами мне помогает публичный анонс, как инструмент самоманипуляции. Если я чувствую, что могу съехать — рассказываю тем, чьё порицание для меня будет болезненным, чьё мнение имеет авторитет для меня в области вопроса. Или проще — рассказываю про это в соцсетях, там отдельное раздолье. 
    И теперь, каждый раз, когда я хочу съехать с дела, представляю, как придётся объяснять значимым для меня людям почему и как так получилось или попросту понимаю, насколько это может оказаться огорчением для тех, кто мог вдохновиться моим примером в соцсетях. И приходится возвращаться!
    Например, не так давно я взялся за проект в обучении, понимая, что запал может пропасть, рассказал об этом своему кругу общения ещё до того, как он случился. Раза три становилось тошно при подготовке из-за нагрузки, настроения, неправильных шагов с моей стороны. И всё же, чудо — никто не сглазил, проект вышел! Чем я сейчас безмерно доволен 🥳
    Уйдём из профессиональной сферы: последние лет 12 мечтал о тату-проекте, который требует много сил, денег, времени и приносит нереальное количество боли в процессе реализации. В прошлый раз, почти 7 лет назад, я не смог довести его до конца. Просто не можете представить настолько ненавижу процесс нанесения тату! В этот раз периодически выкладываю прогресс в соцсети, некоторые друзья откровенно ждут финального результата. И вот прямо вижу лица моих друзей, если я сольюсь сейчас на полпути... Вновь и вновь иду терпеть, потихоньку дотаскивая задумку до конца. Это снова работает!
    Напоследок поделюсь тем, как метод можно усилить: вложите свои личные деньги в проект. Тогда вы с удвоенной прочностью никуда не денетесь — за вами наблюдают укоризненные взгляды тех, кому вы рассказали, а им помогает жаба, нежно обвивающая вашу шею в удушающем приёме. Не благодарите! ❤️`,
  },
  {
    id: 3,
    ...
    Любой перерыв от типичного уклада и темпа жизни или работы — это стресс. Реакция на стресс у всех разная. Выход из стресса тоже для каждого индивидуален. 
    Вместо нравоучений от окружающих и самоистязаний что вы тупица нужно сконцентрироваться на тех практиках, которые вам помогут возвращать скорость обработки информации в необходимую для полноценной работы и чувстовать себя лучше ментально и физически.
    Опять же, акцентирую, у всех индживидуально и нет единого рецепта, как это сделать именно вам. Но точно в моих силах поделиться теми методами, которые помогают мне.
    1. Я обожаю составлять планы на год. Прям со списком дел, главной целью, с делением по месяцам. Делаю это всегда и, о ужас, даже им следую! Первое, что нужно сделать — это составить план, в котором январь и февраль будут манимально достигаторскими. Да, там обязательно должно быть что-то, к чему вы двигаетесь в этом году, но в формате: январь — лежим в нужную сторону, февраль — начинаем ползти, март — двигаемся на карачках, и так далее.
    2. Вытащить всё, что сейчас требуется держать в оперативной памяти мозга, в планер / ежедневник / любое приложение с задачами. Это нужно для того, чтобы не упустить всё задуманное в моменте, пока мозг уязвим и расслабился. И конечно, ставить прекрасные галочки тому, что вы сделали 🙂
    3. Раскачивать тот самый расслабленный мозг. Например, учить пару-тройку новых слов в день или дисциплинированно ежедневно читать книгу (именно книгу: не рабочую почту, не документы на подпись, не этикетки от шампуня (привет, Ксюша!) — книгу, бумажную или электронную). В идеале, не особо имеющую отношение к вашей прямой деятельности. Здесь главное не сколько, а как. А как? Регулярно! 
    4. Включать элементы физической активности, чтобы вместе с мозгом раскачивалось и тело. Если занимаетесь фитнесом — пора возвращаться, если погода позволяет — выходите прогуляться на улицу, а если нет — включайте любимую музыку и танцуйте. Да-да, как там: словно вас никто не видит и бла-бла-бла. Главное без надрывов. Ваш организм не поймёт, если вы тюленьчик по натуре, но решили бежать марафон в январе. 
    5. Общаться и поддерживать контакт с такими же «по типу раскачки». Будет очень больно, если вокруг вас будут все только про «успешный успех», тут никакие практики не помогут. Сейчас лучшее время пообщаться с себеподобными. 
    В этом, кстати, очень может помочь наш чатик лампового комьюнити удалёнщиков. Условно, если не уходить в подробности, выделю три типа состояний ко второй рабочей неделе января:
    — Гордый гепард, который и не заметил выходных (или их и не было) и держит темп, как ни в чём не бывало.
    — Уверенная альпака, кто уже пришла в себя и прекрасно оправилась от оливьешной диеты. 
    — Спокойная капибара, которая пока тупит, но теперь знает, что это нормально и она не одна. `,
  },
  {
    id: 4,
    ...
    2. Чат руководителей. 
    Это чат для меня и моих «директов» (сотрудников в прямом подчинении). Чат используется для быстрой координации по орг.моментам, принятия решений и обсуждения кросс-командных вопросов. 
    3. Чат структурной команды.
    Таких команд у меня получается три — чатов тоже. Состав чата: руководитель группы, его сотрудники и я. Такой чат помогает увести из п.1 обсуждение вопросов, для которых необходимо решение только внутренним составом и формируется четкое понимание состава группы и зона ответственности команды. Важно: в чате техников должны быть именно техники, в чате операционного управления — операционные руководители и всё. Все остальные участники всегда доступны в п.1. 
    4. Чаты профильных специалистов. 
    У нас есть специалисты по контенту, администраторы, кураторы, поддержка — все они существуют по отдельности. Работают те же принципы из п.3. Дополнительная ценность — в такой чат можно добавить любого необходимого участника, а он, в свою очередь, может замьютить его до призыва. Очень удобно! ✨
    5. Общая флудилка. 
    Вся команда из чатов выше нуждается в том, чтобы выпустить пар, поболтать, поделиться фотографией кота или классным мемом. Если добавить в него бота с гороскопами, анекдотами, мемами и полезными командами — становится особенно уютно.
    6. Склад полезного. 
    У нас есть чат, который называется «Сундук». Собственно, как сундук он и используется. Там складируется всё, что бывает необходимо найти под рукой. 
    7. Публичный канал.
    Мы — инфраструктура. Это значит, что работаем на большое количество внутренних заказчиков. Нам важно своевременно и полно информировать об изменениях, новостях и планах. Канал — один из способов решить эту задачу.  
    Не учитываю здесь внутреннюю специфику: например, у нашей поддержки есть чат с лучшими ответами и чат, куда публикуются ответы, которые очень бы хотелось, но отправить нельзя 😉 
    И конечно, распределенные исполнители, маленькая армия из 3000 сотрудников, тоже поделена на логические части по выполняемым проектам. 
